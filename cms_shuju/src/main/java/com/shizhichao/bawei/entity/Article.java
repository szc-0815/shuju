...
public class Article {
	...
	private Integer channel_id;//频道表主键
	private Integer category_id;//分类表主键
	private Integer user_id;//用户表主键
	private Integer hits;//点击次数
	private Integer hot;//是否热门
	private Integer status;//0：刚发布，1：审核通过，-1：审核未通过
	private Integer deleted;//1：表示删除，逻辑删除
	private String created;//发布时间
	private String updated;//最后更新时间
